...
public class ShareListCellRenderer implements ListCellRenderer<PanboxShare> {

	public ShareListCellRenderer() {
	}

	@Override
	public Component getListCellRendererComponent(
			JList<? extends PanboxShare> list, PanboxShare value, int index,
