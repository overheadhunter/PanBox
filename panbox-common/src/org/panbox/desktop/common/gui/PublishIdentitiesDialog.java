 ...
 */
public class PublishIdentitiesDialog extends javax.swing.JDialog {
	 ...
	 */
	public PublishIdentitiesDialog(PanboxClient client,
	...
	private void checkExportability() {
		if ((exportPINTextField.getText() == null)
			...
			distributionLinkTextField.setText("");
		} else {
    ...
    private void initComponents() {
        ...
        exportPINLabel.setText(bundle.getString("PublishIdentitiesDialog.publishPINLabel")); // NOI18N
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(exportPINTextField)
                            .addComponent(distributionLinkTextField))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(genPINButton, javax.swing.GroupLayout.DEFAULT_SIZE, 70, Short.MAX_VALUE)
		...
		try {
			...
			if (!vcardFile.canWrite()) {
				...
				if (exportPINTextField.getText() != null
					...
					client.exportContacts(contacts, vcardFile, Utils
							.toUTF8String(exportPINTextField.getText())
							.toCharArray());

					// generate checksum
					byte[] h = CryptCore.genChecksum(vcardFile);
					...
					distributionLinkTextField
							.setText(PanboxURICmdImportIdentity.getPanboxLink(
									ret, h).toString());
	...
	private void genPINButtonActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_genPINButtonActionPerformed
		try {
			...
			JOptionPane
					.showMessageDialog(
							this,
							bundle.getString("PublishIdentitiesDialog.errorDuringDataGeneration"),
