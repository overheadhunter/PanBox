...
public class DokanOptions {
    ...
    public DokanOptions(final String mountPoint, final int threadCount, final long optionsMode) {
    ...
    public String toString() {
        return "DokanOptions(" + "mountPoint=" + mountPoint + "," + "threadCount=" + threadCount + "," + "optionsMode="
                + optionsMode + ")";
    }
}
