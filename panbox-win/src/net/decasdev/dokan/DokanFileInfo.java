...
public class DokanFileInfo {
    ...
    public DokanFileInfo(final long handle, final int processId, final boolean isDirectory) {
        this.handle = handle;
    ...
    public String toString() {
        return "DokanFileInfo(" + "handle=" + handle + "," + "processId=" + processId + "," + "isDirectory=" + isDirectory
                + ")";
    }
}
